...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2023 a las 13:37:35
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CARGAR_EXPEDIENTE` (IN `ID` INT)  BEGIN
DECLARE IDAREA INT;
SET @IDAREA :=(SELECT area_id FROM usuario WHERE usu_id=ID);
SELECT
...
FROM
	...
	ON 
		...
		WHERE documento.area_destino=@IDAREA OR documento.area_origen=@IDAREA
				ORDER BY doc_fecharegistro desc LIMIT 10; 
		END$$
...
FROM
	...
	ORDER BY mov_fecharegistro ASC$$
...
FROM
	...
	ON 
		documento.area_destino = destino.area_cod
	WHERE area_origen=IDAREA AND documento.doc_estatus='PENDIENTE'
				ORDER BY doc_fecharegistro desc$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_TRAER_DATOS_EXPEDIENTE` (IN `ID` CHAR(12))  SELECT
	documento.documento_id,
	documento.doc_dniremitente,
	documento.doc_nombreremitente,
	documento.doc_apepatremitente,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_TRAER_DATOS_EXPEDIENTE_ADMIN` ()  SELECT
	documento.documento_id, 
	documento.doc_dniremitente, 
	CONCAT_WS(' ',documento.doc_nombreremitente,documento.doc_apepatremitente,documento.doc_apematremitente) AS REMITENTE, 
	documento.doc_nombreremitente, 
...
(9, 'PLANIFICACION', '2023-09-18 20:43:13', 'ACTIVO'),
(10, 'JHJHBHJ', '2023-11-10 23:26:18', 'ACTIVO');
...
('D0000011', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 3, '213', 5, 'VERIFICAR DOCUMENTOS', 'controller/tramite/documentos/ARCH26-9-2023-14-336.PDF', '2023-09-26 14:10:19', 1, 'RECHAZADO', 1, 5, 11, 0, NULL, '-2. TRAMITAR--3. REVISAR-ON', '', 2),
('D0000012', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 2, '34544', 3, 'TODO', 'controller/tramite/documentos/ARCH26-9-2023-14-537.PDF', '2023-09-26 14:15:29', 1, 'FINALIZADO', 5, 5, 12, 0, NULL, '-2. TRAMITAR-ON', 'DOD', 1),
('D0000013', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 3, '4565', 4, 'RESPUESTA', 'controller/tramite/documentos/ARCH26-9-2023-14-913.PDF', '2023-09-26 14:23:41', 1, 'FINALIZADO', 5, 5, 13, 0, NULL, '-3. REVISAR-4. -V° B°-ON', '', 1),
('D0000014', '15511515', 'LUIS', 'CAMACHO', 'VELARDE', '926622656', 'luis2112@gmail.com', 'JR. HUANCAVELICA N° 323', 'A NOMBRE PROPIO', '', '', 2, '3434', 5, 'VERIFICAR', 'controller/tramite/documentos/ARCH26-9-2023-14-915.PDF', '2023-09-26 14:28:18', 1, 'FINALIZADO', 1, 1, 14, 0, NULL, '4. -V° B°-ON', '', 2),
('D0000015', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 2, '9999', 5, 'VERIFICAR DOCUMENTO', 'controller/tramite/documentos/ARCH26-9-2023-14-322.PDF', '2023-09-26 14:36:37', 1, 'FINALIZADO', 5, 5, 15, 0, NULL, '-2. TRAMITAR--3. REVISAR-4. -V° B°-ON', 'W', 1),
('D0000016', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 2, '2222', 4, 'VER EL DOCUMENTO Y DAR VISTO BUENO', 'controller/tramite/documentos/ARCH26-9-2023-14-140.PDF', '2023-09-26 14:40:17', 1, 'FINALIZADO', 5, 5, 16, 0, NULL, '4. -V° B°-ON', '', 1),
('D0000017', '55151151', 'JOSE', 'SANCHEZ', 'MEDINA', '926262625', 'jose21@gmail.com', 'JR. CHALHUANCA N° 222', 'A NOMBRE PROPIO', '', '', 3, '4523', 5, 'REVISAR PRESUPESTO DE MESA DE PARTES DEL MES DE OCTUBRE', 'controller/tramite/documentos/ARCH18-10-2023-15-50.PDF', '2023-10-18 15:32:06', 1, 'FINALIZADO', 1, 1, 17, 0, NULL, '-2. TRAMITAR--3. REVISAR-ONON', '', 2);
...
CREATE TABLE `empleado` (
  ...
  `empl_modalidad` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `empleado` (`empleado_id`, `emple_nombre`, `emple_apepat`, `emple_apemat`, `emple_feccreacion`, `emple_fechanacimiento`, `emple_nrodocumento`, `emple_movil`, `empl_modalidad`, `emple_email`, `emple_estatus`, `emple_direccion`, `empl_fotoperfil`) VALUES
(1, 'JERSSON JORGE', 'CORILLA', 'MIRANDA', '2023-03-01', '2023-03-31', '234234', '918654046', 'Funcionario', 'jersson14071996@gmail.com', 'ACTIVO', 'JR. NICOLAS DE PIEROLA Nº 105', 'controller/empleado/FOTOS/IMG28-8-2023-11-64.jpg'),
(2, 'JOSE', 'SANCHEZ', 'MEDINA', '2023-08-25', '1985-01-24', '55151151', '926262625', 'CAS', 'jose21@gmail.com', 'ACTIVO', 'JR. CHALHUANCA N° 222', 'controller/empleado/FOTOS/IMG28-8-2023-11-195.png'),
(3, 'ANDREA', 'SANCHEZ', 'JIMENEZ', '2023-08-25', '1995-01-24', '26626266', '966226262', 'CAS', 'andrea12@gmail.com', 'ACTIVO', 'AV. DIAZ BARCENAS N° 323', 'controller/empleado/FOTOS/IMG28-8-2023-11-271.jpeg'),
(4, 'LUIS', 'CAMACHO', 'VELARDE', '2023-08-25', '1998-01-24', '15511515', '926622656', 'Servidor Público', 'luis2112@gmail.com', 'ACTIVO', 'JR. HUANCAVELICA N° 323', 'controller/empleado/FOTOS/IMG21-10-2023-15-225.png'),
(5, 'JUAN CARLOS', 'MEDINA', 'SANCHEZ', '2023-08-27', '2000-07-25', '62262626', '926161616', 'Practicante', 'juanca2@gmail.com', 'ACTIVO', 'JR. CUSCO N° 323', 'controller/empleado/FOTOS/IMG8-11-2023-9-146.png'),
(6, 'CELIA', 'MIRANDA', 'MUNGUIA', '2023-08-29', '1972-01-24', '09747535', '988505521', 'Tercero', 'cmirandam@utea.edu.pe', 'ACTIVO', 'JR NICOLAS DE PIEROLA N° 105', 'controller/empleado/FOTOS/IMG29-8-2023-16-940.jpg'),
(7, 'WILFREDO', 'CARRIÓN', 'UMERES', '2023-09-07', '1995-05-11', '31044054', '952541551', 'CAS', 'willy22@gmail.co', 'ACTIVO', 'AV 28 DE ABRIL 234', 'controller/empleado/FOTOS/IMG7-9-2023-18-768.jpg'),
(8, 'ELIAS', 'CARRIÓN', 'UMERES', '2023-09-10', '1985-05-25', '41239943', '935951872', 'Tercero', 'eliascar888@hotmail.com', 'ACTIVO', 'AV 28 DE ABRIL N° 234', 'controller/empleado/FOTOS/IMG10-9-2023-11-957.jpg'),
(9, 'PEDRO', 'JIMENEZ', 'SANCHEZ', '2023-10-22', '1980-08-14', '51151515', '915151551', 'CAS', 'pedro3@gmail.com', 'ACTIVO', 'AV. CANADA S/N', 'controller/empleado/FOTOS/usuario.png'),
(10, 'JOSUE', 'SANCHEZ', 'PERALTA', '2023-10-22', '1990-01-15', '65611661', '915615515', 'Funcionario', 'josue21@gmail.com', 'ACTIVO', 'JR. CUSCO N° 455', 'controller/empleado/FOTOS/usuario.png');
...
(2, 'DIRESA ABANCAY', 'DIRESA123@GMAIL.COM', '14521', '952652145', 'AV. DANIEL ALCIDES CARRION S/N ABANCAY APURíMAC', 'controller/empresa/FOTOS/IMG22-10-2023-11-977.png');
...
(28, 'D0000011', 1, 5, '2023-09-26 14:10:19', 'NO CUMPLE', 'RECHAZADO', 2, 'controller/tramite/documentos/ARCH26-9-2023-14-336.PDF', NULL, '-2. TRAMITAR--3. REVISAR-ON'),
(29, 'D0000012', 1, 5, '2023-09-26 14:15:29', 'sdfsdf', 'DERIVADO', 3, 'controller/tramite/documentos/ARCH26-9-2023-14-537.PDF', NULL, '-2. TRAMITAR-ON'),
(34, 'D0000012', 5, 5, '2023-09-26 14:22:22', 'H', 'FINALIZADO', 5, '', NULL, '4. -V° B°-'),
(35, 'D0000013', 1, 5, '2023-09-26 14:23:41', 'RESPUESTA', 'DERIVADO', 3, 'controller/tramite/documentos/ARCH26-9-2023-14-913.PDF', NULL, '-3. REVISAR-4. -V° B°-ON'),
(37, 'D0000014', 5, 1, '2023-09-26 14:28:18', 'VERIFICAR', 'DERIVADO', 5, 'controller/tramite/documentos/ARCH26-9-2023-14-915.PDF', NULL, '4. -V° B°-ON'),
(38, 'D0000014', 1, 1, '2023-09-26 14:34:32', 'VB', 'FINALIZADO', 3, 'controller/tramite_area/documentos/ARCH26-9-2023-14-604.PDF', NULL, ''),
(39, 'D0000015', 1, 5, '2023-09-26 14:36:37', 'VERIFICAR DOCUMENTO', 'FINALIZADO', 3, 'controller/tramite/documentos/ARCH26-9-2023-14-322.PDF', NULL, '-2. TRAMITAR--3. REVISAR-4. -V° B°-ON'),
(40, 'D0000015', 5, 5, '2023-09-26 14:37:14', 'VISTO BUENO', 'FINALIZADO', 5, 'controller/tramite_area/documentos/ARCH26-9-2023-14-380.PDF', NULL, '-2. TRAMITAR-4. -V° B°-'),
(41, 'D0000016', 1, 5, '2023-09-26 14:40:17', 'VER EL DOCUMENTO Y DAR VISTO BUENO', 'DERIVADO', 3, 'controller/tramite/documentos/ARCH26-9-2023-14-140.PDF', NULL, '4. -V° B°-ON'),
(42, 'D0000016', 5, 5, '2023-09-26 14:42:02', 'DADO VB', 'FINALIZADO', 5, 'controller/tramite_area/documentos/ARCH26-9-2023-14-901.PDF', NULL, '4. -V° B°-'),
(43, 'D0000017', 1, 3, '2023-10-18 15:32:06', 'REVISAR PRESUPESTO DE MESA DE PARTES DEL MES DE OCTUBRE', 'DERIVADO', 3, 'controller/tramite/documentos/ARCH18-10-2023-15-50.PDF', NULL, '-2. TRAMITAR--3. REVISAR-ONON'),
(44, 'D0000017', 3, 1, '2023-10-18 15:41:54', 'SE DIO RESPUESTA DEL TRAMITE', 'DERIVADO', 4, 'controller/tramite_area/documentos/ARCH18-10-2023-15-162.PDF', NULL, '-10. DAR RESPUESTA-'),
(45, 'D0000017', 1, 1, '2023-10-18 15:43:50', 'FINALIZADO', 'FINALIZADO', 3, '', NULL, '-17. INFORME-');
...
ALTER TABLE `documento`
  ...
  ADD KEY `doc_nrodocumento` (`doc_nrodocumento`);
...
--
ALTER TABLE `movimiento`
  MODIFY `movimiento_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
