<script src="../js/console_buscar_fecha_area.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>REPORTES POR FECHA Y ÁREA</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Trámites</b></h3>
                ...
                <div class="col-12 col-md-3" role="document">
                    <div class="form-group">
                    <label for="select_area_p">Área Localizada:</label>
                        <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-th"></i>
                        ...
                        <select type="text" class="form-control js-example-basic-single" id="select_area_p" name="select_area_p" style="width:80%"></select>
                        <div class="valid-input invalid-feedback"></div>
                    </div>
                    </div>
                </div>
...
<div class="modal fade" id="modal_mas" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <h5 class="modal-title" id="lb_titulo_datos">Datos del Tramite</h5>
      </div>
      <div class="modal-body">
        <div class="row">
        <div class="col-12">
